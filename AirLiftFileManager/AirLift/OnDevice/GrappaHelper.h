// GrappaHelper.h — ported verbatim from AirCard-iOS (MIT, Mak5er; see
// docs/ATTRIBUTION.md). C ABI for the authentic Grappa client token used by
// AirTraffic sync (HostInfo/RequestingSync Grappa field).
